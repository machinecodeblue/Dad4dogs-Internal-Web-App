...
**Emergency (refined 2026-08-24):** its **own card**, heading **Emergency Contacts**. Collapsed = heading only. Expanded = name + yellow button with that person's phone (and pickup). Not a second button under Call.
