...
**What we left:** later customer-summary layout (edit beside name, visible address, COI as ✓ / missing warning) was decided separately — see `Decisions/Gemini analysis of the customer details UI.md`. Do not re-hide customer address or restore a COI card from this note.
